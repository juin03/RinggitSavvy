    ...
    <View style={{ flexDirection: "row", alignItems: "center", paddingVertical: 10 }}>
      ...
      <View>
        <TouchableOpacity onPress={() => { }}>
          <Text style={{ fontSize: 18, fontFamily: "Inter-Bold", color: Colors.BLACK }}>{title}</Text>
        </TouchableOpacity>
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={{ backgroundColor: Colors.WHITE, marginBottom: 10 }}>
        ...
        <View style={{ marginTop: -45, paddingHorizontal: 10 }}>
          <Text style={{ fontSize: 28, fontFamily: "Inter-Bold", color: Colors.BLACK, width:360 }}>{user?.fullName}</Text>
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Text style={{ color: Colors.BLUE, fontSize: 16, fontFamily: "Inter-Bold" }}>{DATA.INFO.followers} followers</Text>
            <Icon name='dot-single' size={16} color={Colors.GRAY} />
            <Text style={{ color: Colors.BLUE, fontSize: 16, fontFamily: "Inter-Bold" }}>{DATA.INFO.connections > 500 ? "500+" : DATA.INFO.connections} connections</Text>
          </View>
        </View>
